...
const Hermeneutics = () => {
  return (
    <Box sx={{ background: 'white', borderRadius: 2, padding: 4, boxShadow: 1 }}>
      <h1 style={{textAlign: 'center', fontWeight: '900'}}>{`CREATIVE HERMENEUTICS`}</h1>
      <h2 style={{textAlign: 'center', fontWeight: '900', color: '#757575'}}>{`Dr. Fu's innovative methodology for dealing with texts, especially philosophical texts, has been applied in many venues, from Confucianism and Buddhism to Amero-European thought. The goal is to elicit a faithful reading of past thought and thinkers that is simultaneously applicable to the present, while leaving room for further open-ended explorations in the future.`}</h2>

...
import { H2, Subtitle, P, Quot } from 'src/components/commonStyled';

const GreatLearning = () => {
  return (
    <Box sx={{ background: 'white', borderRadius: 2, padding: 4, boxShadow: 1 }}>
      <H2 style={{ textAlign: 'center' }}>{`CREATIVE HERMENEUTICS APPLIED TO THE GREAT LEARNING`}</H2>
      <Subtitle style={{ textAlign: 'center' }}>{`Charles Wei-hsun Fu (1994?)`}</Subtitle>

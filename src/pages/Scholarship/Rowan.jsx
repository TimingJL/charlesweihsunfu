  ...
  return (
    <Box sx={{ background: 'white', borderRadius: 2, padding: 4, boxShadow: 1 }}>
      <div style={{fontSize: '20px', margin: '50px'}}>
        <h3><strong>{`THE CHARLES WEI-HSUN FU MEMORIAL SCHOLARSHIP, ROWAN UNIVERSITY`}</strong></h3>
        <div>{`$2000 in scholarships given annually to students in the Asian Studies Program Glassboro, New Jersey`}</div>
      </div>
